...
// ): GoogleEvent[] {
// 	return totalEventList.reduce(
// 		(allEvents, currentEvent: GoogleEvent): GoogleEvent[] => {
// 			const isAllDayEvent =
// 				currentEvent.start.date && !currentEvent.start.dateTime;

// 			const endMoment = window.moment(
...
// 				endMoment.isSame(
// 					startMoment.clone().add(1, "day").startOf("day"),
// 					"minute"
// 				)
// 			) {
...
// 					.clone()
// 					.endOf("day")
// 					.diff(startMoment.clone().startOf("day"), "days") + 1;
...
// 				} else {
// 					if (isAllDayEvent) {
// 						newEvent.end.date = startMoment
// 							.endOf("day")
// 							.format("YYYY-MM-DD");
// 					} else {
// 						newEvent.end.dateTime = startMoment
// 							.endOf("day")
// 							.toISOString();
// 					}
// 				}
...
// 					const eventStart = window.moment(
