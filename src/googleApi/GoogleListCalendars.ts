...
// import GoogleEventsPlugin from "src/GoogleCalendarPlugin";
...
//  */
// function filterCalendarsByBlackList(plugin: GoogleEventPlugin, calendars: GoogleCalendar[]): GoogleCalendar[] {
